...
<body style="background-color:powderblue;">
    ...
    <div class="profile_container">
        ...
        if (isset($_POST['upload'])) {
            ...
            $sql = "INSERT INTO post (image,user_id,title,name) VALUES ('$image','$data','$name','$result')";
                    ...
                    <div id="id01" class="modal">
                        <form method="POST" action="" enctype="multipart/form-data" class="modal-content animate" name="my">
                            ...
                            <div class="container">
                                ...
                                <input type="text" name="name" required style="height: 100px; " placeholder="write your post here..">
